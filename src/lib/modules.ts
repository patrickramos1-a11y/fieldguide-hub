            ...
            itemFields: [
              {
                ...
                colorByValue: {
                  ...
                  "Químicos": "#ea580c",
                  "Óleos": "#ea580c",
                  "Pilhas/baterias": "#ea580c",
                  "Lâmpadas": "#ea580c",
                  "EPI contaminado": "#ea580c",
                  "Entulho": "#64748b",
                  "Construção civil": "#64748b",
                  "Não inerte": "#f59e0b",
                },
              },
              {
              ...
              { id: "periodicidade", label: "Periodicidade", type: "button-select", allowOther: true, learn: true, applyToOthers: true, options: ["Diária", "Semanal", "Quinzenal", "Mensal", "Eventual"] },
              { id: "acondicionamento", label: "Acondicionamento", type: "button-select", allowOther: true, learn: true, applyToOthers: true, options: ["Bombona", "Big bag", "Tambor", "Saco plástico", "Container", "Caixa de papelão", "Pallet", "A granel"] },
              { id: "destino", label: "Destinação", type: "button-select", allowOther: true, learn: true, applyToOthers: true, options: ["Aterro sanitário", "Aterro industrial", "Reciclagem", "Reuso interno", "Compostagem", "Coprocessamento", "Incineração", "Logística reversa"] },
              { id: "coletor", label: "Quem coleta", type: "button-select", allowOther: true, learn: true, applyToOthers: true, options: ["Coleta pública", "Empresa terceirizada", "Catador", "Logística reversa do fornecedor"] },
            ],
          },
        ],
      },
